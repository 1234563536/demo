<template>
  <div class="user-manage">
        ...
        <el-table-column label="操作" width="220">
          <template #default="scope">
            ...
            <el-button
              ...
              @click="handleDel(scope.row._id)"   v-has="'menu-delete'"
              >删除</el-button
            >
          </template>
        </el-table-column>
    ...
    <el-dialog :title="this.action==='add'?'':''" v-model="showModal" :close-on-click-modal='false' :close-on-press-escape='false' :show-close="false">
      <el-form
        ref="dialogForm"
        :model="menuForm"
        label-width="100px"
...
export default {
  ...
  methods: {
    ...
    /*       if(this.action==="edit"){
            let params = { ...menuForm, action};
            params.updateTime=new Date().toISOString()
            let resTime=await this.$api.menuUpdate(params);
